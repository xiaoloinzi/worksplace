...
import time
from GR1.AppTestGR.lib.appopera import find_element
...
class HiApp(object):
    ...
    def check_msg(self,**kwargs):
        ...
        print 'assert succ'
        time.sleep(2)
        el2 = find_element(self.driver,'//android.widget.TextView[@text="关于"]')
        el2.click()
        num = 0
        ...
        for i in xrange(1,num+1):
            el3 = self.driver.find_element_by_xpath(unicode(kwargs['check_msg.xpath'+str(i)]))
    ...
    def open_switch(self,**kwargs):
        ...
        time.sleep(1)
        el3 = self.driver.find_element_by_xpath(unicode(kwargs['open_switch.xpath']))
